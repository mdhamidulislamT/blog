...
function formatIcons(state) {
        ...
        var $state = $(
                '<span class="fa_icons"><i class="' + state.text + '"></i> ' + state.text + '</span>'
        );
        return $state;
};
...
$(function () {
        ...
        if ($(".select2faicons").data('value'))
                s2.val($(".select2faicons").data('value')).trigger("change")
});